...
class Ins2Orc(object):
    ...
    def insert_(self,state,b_r,result_dict,DEVICECODE,result_cp,end_result_cp):
        ...
        param = [
            (DEVICECODE, datetime.datetime.now(), state, b_r, result_dict['0'], result_dict['1'], result_dict['2']), ]
        param_1 = [
