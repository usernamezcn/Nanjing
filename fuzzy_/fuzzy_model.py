import numpy as np
import warnings
from parameter_Definition import S_mat_origin,s3_mat_origin
from parameter_Definition import s7_mat_origin,s8_mat_origin,s9_mat_origin,s10_mat_origin,s11_mat_origin
from parameter_Definition import s12_mat_origin,s13_mat_origin,s14_mat_origin,s15_mat_origin,s16_mat_origin,s17_mat_origin
