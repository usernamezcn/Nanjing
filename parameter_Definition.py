...
num_x1_miss,num_x2_miss,num_repeat,jump,num_zero,sliding = \
    int(data_oracle.loc['num_x1_miss'].values[0]),int(data_oracle.loc['num_x2_miss'].values[0]), \
    int(data_oracle.loc['num_repeat'].values[0]),int(data_oracle.loc['jump'].values[0]), \
    int(data_oracle.loc['num_zero'].values[0]),int(data_oracle.loc['sliding'].values[0])
